...
PLUGIN = LanguageQueryPlugin(
    ...
    hinted_rules={
        ...
        "manual_lock_unlock": ("R.1", "CP.20", "CP.21", "CP.22", "CPP.PROJ.3"),
        "ownership_ambiguity": ("I.11", "R.20", "R.11", "CPP.PROJ.1"),
        "return_move_local": ("F.48",),
        "primitive_types": ("I.4", "F.16"),
        "direct_system_header": ("SF.13", "P.11", "CPP.PROJ.2", "CPP.PROJ.4"),
        "direct_system_call": (
            "SL.io.3",
            "P.11",
            "E.19",
        ...
        "primitive_format_specifier": ("SL.io.3", "ES.34", "CPP.PROJ.5"),
    },
