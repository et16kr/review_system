...
DIRECT_CATEGORY_SIGNALS: dict[str, set[str]] = {
    "memory": {"raw_new", "malloc_free", "manual_delete", "free_without_null_reset"},
    "error_handling": {"ide_rc_flow", "ide_exception_flow", "ide_assert", "error_code_flow"},
    "wrapper_usage": {"direct_system_call", "manual_lock_unlock"},
    "portability": {"direct_system_header", "include_portability"},
    "control_flow": {"continue_usage", "switch_without_default", "for_initializer_declaration"},
    "comment_usage": {"line_comment", "commented_out_code"},
    "format_usage": {"primitive_format_specifier", "printf_usage"},
    "type_usage": {"primitive_types", "primitive_type_usage", "typedef_usage"},
}
