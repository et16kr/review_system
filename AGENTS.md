...
- `docs/`
  - API 계약, 운영 절차, migration/cutover, 설계/히스토리 문서
...
2. `review-bot` 변경이면 먼저 아래 문서를 확인
   ...
   - [docs/REVIEW_BOT_MIGRATION_CUTOVER.md](/home/et16/work/review_system/docs/REVIEW_BOT_MIGRATION_CUTOVER.md:1)
...
- [docs/REVIEW_BOT_FUNDAMENTAL_REVIEW.md](/home/et16/work/review_system/docs/REVIEW_BOT_FUNDAMENTAL_REVIEW.md:1)
- [docs/REVIEW_BOT_FUNDAMENTAL_REVIEW_DECISION_LOG.md](/home/et16/work/review_system/docs/REVIEW_BOT_FUNDAMENTAL_REVIEW_DECISION_LOG.md:1)
- [docs/REVIEW_BOT_FUNDAMENTAL_REVIEW_DETAILED_DESIGN.md](/home/et16/work/review_system/docs/REVIEW_BOT_FUNDAMENTAL_REVIEW_DETAILED_DESIGN.md:1)

이전 문서 흐름은 archive에 보관했습니다.

- [docs/archive/review_bot_fundamental_review_history/README.md](/home/et16/work/review_system/docs/archive/review_bot_fundamental_review_history/README.md:1)
...
반드시 `ops/scripts/smoke_local_gitlab_tde_review.sh`까지 다시 돌려야 합니다.
